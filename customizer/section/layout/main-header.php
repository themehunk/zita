...
// Pro feature 
$wp_customize->add_setting('zita_main_header_zita_main_header_space', array(
    'sanitize_callback' => 'zita_sanitize_text',
    ));
$wp_customize->add_control(new Zita_Misc_Control( $wp_customize, 'zita_main_header_zita_main_header_space',
            array(
        'section'     => 'zita-main-header',
        'type'        => 'custom_message',
...
$wp_customize->add_control(
            new Zita_WP_Customize_Control_Radio_Image(
                $wp_customize, 'zita_main_header_space', array(
                    'label'    => esc_html__( 'Some More Pro Features', 'zita' ),
                    'section'  => 'zita-main-header',
                    'priority'   => 108,
                    'choices'  => array(
                        'headerPro'   => array(
                            'url' => ZITA_MAINHEADER_PRO,
                        ),       
                    ),
                )
            )
