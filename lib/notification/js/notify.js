jQuery(document).ready(function($) {
    ...
    $('#activate-zita-pro').on('click', function() {
        var pluginSlug = $(this).data('slug');
        handlePluginAction(pluginSlug, 'activate');
    });

    $('#activate-zita-site-library').on('click', function() {
        var pluginSlug = $(this).data('slug');
        handlePluginAction(pluginSlug, 'activate');
    });

    $('#install-zita-site-library').on('click', function() {
        var pluginSlug = $(this).data('slug');
   ...
   $('.notice-dismiss').on('click', function(e) {
        ...
        if (confirmation) {
            ...
            if (link) {
                ...
                document.cookie = "zita_thms_time=" + date.getTime() + "; expires=" + date.toUTCString() + "; path=/";
